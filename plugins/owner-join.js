...
for (let jid of data.map(([id]) => [id] + '@s.whatsapp.net').filter(v => v != conn.user.jid)) await m.reply('*[❗𝙄𝙣𝙛𝙤❗] 𝑺𝒐𝒍𝒊𝒄𝒊𝒕𝒖𝒅 𝒑𝒂𝒓𝒂 𝒖𝒏 𝒈𝒓𝒖𝒑𝒐  \n\n*—◉ 𝑺𝒐𝒍𝒊𝒄𝒊𝒕𝒂𝒏𝒕𝒆:* ' + 'wa.me/' + m.sender.split('@')[0] + '\n*—◉ 𝑬𝒏𝒍𝒂𝒄𝒆 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐:* ' + link, jid)
